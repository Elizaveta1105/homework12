...
# book.add_record(Record("John14"))
# book.add_record(Record("John15"))
# book.add_record(Record("jo2", "1234567890"))
# book.add_record(Record("jo3", "1234567890"))
# book.add_record(Record("jo24", "1234567890"))
#
# print(book.search("90"))
